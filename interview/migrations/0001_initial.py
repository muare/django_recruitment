# Generated by Django 3.2.7 on 2021-09-26 03:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('学士', '学士'), ('硕士', '硕士'), ('博士', '博士')], max_length=128, verbose_name='学历')),
                ...
                ('first_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='初试分数')),
                ...
                ('first_recommend_position', models.CharField(max_length=128, verbose_name='推荐部门')),
                ...
                ('second_score', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='复试分数')),
                ...
                ('second_result', models.CharField(blank=True, choices=[('建议录用', '建议录用'), ('待定', '待定'), ('放弃', '放弃')], max_length=128, verbose_name='复试结果')),
                ('second_recommend_position', models.CharField(max_length=128, verbose_name='推荐部门')),
                ...
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='终试综合等级')),
                ('hr_responsibility', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='责任心')),
                ('hr_communication_ability', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='坦诚沟通')),
                ('hr_logical_ability', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='逻辑思维')),
                ('hr_potential', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='发展潜力')),
                ('hr_stability', models.CharField(blank=True, choices=[('S', 'S'), ('C', 'C'), ('C', 'C'), ('C', 'C')], max_length=16, verbose_name='稳定性')),
                ...
                ('hr_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=128, verbose_name='终试结果')),
